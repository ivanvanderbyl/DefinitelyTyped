...
declare type Serializable = string | boolean | number | null | object;
...
export interface Page extends FrameBase {
	...
	on<K extends keyof EventObj>(event: K, handler: (e: EventObj[K], ...args: any[]) => void): void;
	...
	evaluateOnNewDocument(fn: EvaluateFn<string>, ...args: object[]): Promise<void>;
